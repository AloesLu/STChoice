//
//  MHTeacherTabBarViewController.m
//  STChoice
//
...
@interface MHTeacherTabBarViewController ()<UITabBarControllerDelegate>

@end

@implementation MHTeacherTabBarViewController
...
- (void)viewDidLoad {
    ...
    STTeacherChooseViewController *scVC=[[STTeacherChooseViewController alloc]init];
    MHBaseNavigationController *nav_scVC=[[MHBaseNavigationController alloc]initWithRootViewController:scVC];
    UITabBarItem *item1 = [self _makeItemWithTitle:@"筛选学生" normalName:@"01" selectedName:@"001" tag:100];
    [nav_scVC setTabBarItem:item1];
    [aryControllers addObject:nav_scVC];
    
    STTeacherSureViewController *ssVC=[[STTeacherSureViewController alloc]init];
