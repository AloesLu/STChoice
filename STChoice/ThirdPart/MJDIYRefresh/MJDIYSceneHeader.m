...
//  vomoho
//
//  Created by AloesLu on 16/2/29.
//  Copyright © 2016年 AloesLu. All rights reserved.
//

#import "MJDIYSceneHeader.h"
#import "MJRefreshConst.h"

@interface MJDIYSceneHeader()
@property (weak, nonatomic) UISwitch *s;
@property (weak, nonatomic) UIImageView *logo;
@property (weak, nonatomic) UIActivityIndicatorView *loading;
@end

@implementation MJDIYSceneHeader
#pragma mark - 重写方法
...
- (void)placeSubviews
{
    ...
    self.logo.center = CGPointMake(self.mj_w * 0.5+5.5, - self.logo.mj_h + 50);
